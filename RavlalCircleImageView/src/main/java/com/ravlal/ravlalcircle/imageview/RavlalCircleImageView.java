package com.ravlal.ravlalcircle.imageview;
...
public class RavlalCircleImageView extends ImageView {
    ...
    public RavlalCircleImageView(Context context) {
        super(context);

        init();
    }

    public RavlalCircleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RavlalCircleImageView(Context context, AttributeSet attrs, int defStyle) {
